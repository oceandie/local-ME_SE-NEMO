...
DOMCFG_zps = '/data/users/dbruciaf/OVF/zps_GO8/ideal/domain_cfg.nc'
inp_dir = '/data/users/dbruciaf/OVF/outputs/ideal/lin_str_ldf/'
TRACER_list = [inp_dir + 'zps/nemo_cg602o_1d_19760101-19760201_grid_T.nc',
               inp_dir + 'zps/nemo_cg602o_1d_19760201-19760301_grid_T.nc',
               inp_dir + 'zps/nemo_cg602o_1d_19760301-19760401_grid_T.nc']
