...
from plot_section_LIW import mpl_sec_loop
...
U_zps = '/data/users/dbruciaf/EN4/interp_GO8_zps/geo_adj/nemo_cv662o_1d_19760302-19760312_grid_U.nc'
V_zps = '/data/users/dbruciaf/EN4/interp_GO8_zps/geo_adj/nemo_cv662o_1d_19760302-19760312_grid_V.nc'

# 2. ANALYSIS
# Line W (Toole et al. 2011)
sec_lon1 = [-71.5, -69.718, -68.28, -66.0]
sec_lat1 = [42.  ,  39.6  ,  37.5 ,  33.8]
...
mpl_sec_loop('Current', '.png', var_strng, unit_strng, date, timeres_dm, timestep, PlotType,
              sec_I_indx_1b_L, sec_J_indx_1b_L, tlon3, tlat3, tdep3, wdep3, tmsk3, da_v.values, 
              proj, coord_type_1b_L, vlevel_1b_L, bathy, [], rbat2_fill_1b_L, mbat_ln, mbat_fill,
