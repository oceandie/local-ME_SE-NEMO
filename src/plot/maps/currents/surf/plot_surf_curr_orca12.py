...
DOMCFG_zps = '/data/users/dbruciaf/P2HR/orca12/domaincfg_eORCA12_v3.0.nc'
...
U_ZPS_EN = '/data/users/dbruciaf/EN4/interp_GO8_zps/geo_adj/orca12/nemo_cv602o_1d_19760302-19760303_grid_U.nc'
...
V_ZPS_EN = '/data/users/dbruciaf/EN4/interp_GO8_zps/geo_adj/orca12/nemo_cv602o_1d_19760302-19760303_grid_V.nc'
...
ds_U_zps_en =  ds_U_zps_en.isel(x_f=slice(1970,3720),y_c=slice(2160,3390))
...
ds_V_zps_en =  ds_V_zps_en.isel(x_c=slice(1970,3720),y_f=slice(2160,3390))
...
# Extracting only the part of the domain we need
ds_bathy    =  ds_bathy.isel(x=slice(1970,3720),y=slice(2160,3390))
ds_dom_zps = ds_dom_zps.isel(x_c=slice(1970,3720),x_f=slice(1970,3720),
                             y_c=slice(2160,3390),y_f=slice(2160,3390))
...
# 1) zps_en
Uzps = U_zps_en.squeeze()[0,:,:]
Vzps = V_zps_en.squeeze()[0,:,:]
